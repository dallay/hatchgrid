...
@SpringBootTest(classes = [HatchgridAutoConfiguration::class, MyCommandHandler::class])
class CommandHandlerTest {
    ...
    fun `should throw exception if given async command does not have handler bean`() {
        ...
        assertEquals("handler could not be found for com.hatchgrid.spring.boot.NonExistCommand", exception.message)
    }
}
