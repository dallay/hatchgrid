...
export const BRAND_NAME: string | Multilingual = "Hatchgrid";
export const SITE_TITLE: string | Multilingual = "Hatchgrid";
...
const BASE_URL_PROD = "https://hatchgrid.pages.dev";
