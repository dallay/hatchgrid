...
Usamos PostgreSQL con enums para `subscriber_status` (ENABLED, DISABLED, BLOCKLISTED) y políticas RLS basadas en `current_setting('lyra.current_organization')` para aislar los datos por organización.
