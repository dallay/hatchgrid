 ...
 * This store is part of the infrastructure layer and handles state management
...
export const useAuthStore = defineStore("auth", {
	...
	actions: {
		...
		setAuthentication(identity: Account) {
			...
			const accountWithImage: Account = {
				...identity,
				imageUrl: identity.imageUrl ?? avatar(identity.email ?? "", 100),
			};
