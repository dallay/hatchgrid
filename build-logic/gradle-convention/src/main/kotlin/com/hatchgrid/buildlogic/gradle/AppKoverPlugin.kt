package com.hatchgrid.buildlogic.gradle

import com.hatchgrid.buildlogic.common.ConventionPlugin
import com.hatchgrid.buildlogic.common.extensions.isRelease
import com.hatchgrid.buildlogic.common.extensions.kover
...
internal class AppKoverPlugin : ConventionPlugin {
    ...
    private val packagesIncludes = listOf("com.hatchgrid")
            ...
            filters {
                ...
                excludes {
                    annotatedBy(
                        ...
                        "com.hatchgrid.common.domain.Generated",
                    )
