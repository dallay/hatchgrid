...
@UnitTest
internal class FetchDetailFormControllerTest {
    private val mediator: Mediator = mockk()
    private lateinit var controller: FetchDetailFormController
    ...
    @BeforeEach
    fun setup() {
        controller = FetchDetailFormController(mediator)
    ...
    fun `should return form when form is found`() {
        ...
        webTestClient.get()
            ...
            .isEqualTo(response)
        val querySlot = slot<DetailFormQuery>()
