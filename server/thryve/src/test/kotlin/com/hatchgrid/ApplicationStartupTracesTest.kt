...
import com.hatchgrid.ApplicationStartupTraces.of
import com.hatchgrid.thryve.TestAppender
...
$SEPARATOR""",
    ...
    fun shouldBuildTraceForEnvironmentWithApplicationName() {
        ...
        Assertions.assertThat(of(environment)).contains("  Application 'Hatchgrid' is running!")
    }
