...
**Auto-generated by scripts/generate-structure-docs.sh on 2025-08-15**
...
│   ├───astro_conventions.md
│   ├───ci_cd_best_practices.md
│   ├───instructions.md
│   ├───keycloak_setup.md
│   ├───kotlin_conventions.md
│   ├───mcp.json
│   ├───playwright_typescript_guidelines.md
│   ├───postgres_rls_security.md
│   ├───product_overview.md
│   ├───project_documentation_guidelines.md
│   ├───project_structure.md
│   ├───rest_endpoints_pattern.md
│   ├───ruler.toml
│   ├───security_practices.md
│   ├───spring_boot_conventions.md
│   ├───tech_stack.md
